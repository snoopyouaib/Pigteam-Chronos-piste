...
// Scanne les adresses I2C 0x08-0x77 (convention standard, evite les
// adresses reservees) et logge (ESP_LOGI, tag "i2c_scan") celles qui
// ACKent. A appeler juste apres I2C_master_Init(), avant tout autre
// init I2C -- diagnostic pur, ne touche a aucun registre de peripherique.
void I2C_scan(void);
