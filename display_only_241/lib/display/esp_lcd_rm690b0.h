...
// Repris tel quel du driver esp_lcd_sh8601.c/h (bring-up 1.91), juste
// renomme -- le framing QSPI (opcodes 0x02 ecriture registre, 0x32
// ecriture couleur, CASET/RASET/RAMWR classiques) est partage par toute
// la famille de controleurs AMOLED QSPI (SH8601, CO5300, RM67162,
// RM690B0...), seule la table d'init vendor_specific_init_default
// (dans le .c) differe reellement d'une puce a l'autre. A valider/
// ajuster au banc sur le vrai 2.41 -- premiere passe basee sur le jeu
// de commandes DCS standard de cette famille (0x11 sleep-out, 0x36
// MADCTL, 0x3A COLMOD, 0x35 TE-on, 0x51 luminosite, 0x29 display-on).
